          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="relative">
                ...
                <div className="w-full aspect-[3/4] bg-gray-200 rounded-lg shadow-lg"></div>
              ...
              <div className="bg-blue-50 p-6 rounded-lg mt-12">
                <h3 className="text-lg font-semibold text-blue-900 mb-3">Education</h3>
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li>• Honours B.A. - University of Toronto
                    <span className="block text-sm ml-4 text-gray-600">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6 text-gray-700">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-lg font-semibold text-blue-900 mb-3">Areas of Focus</h3>
